...
function updateDetails() {
    ...
    det_can.fillRect(0, 0, 1000, 1000);
    var x_offset = 80;
    var y_offset = 60;
...
function drawLocalRule(ruleNum, det_can, x_offset, y_offset) {
    ...
    det_can.fillRect(x_offset+x_col_2, y_offset, box_w, box_h);

    det_can.fillStyle = (ruleNum & 1) ? 'black' : 'white';
    det_can.fillRect(x_offset+x_col_1, y_offset+y_row_2, box_w, box_h);

    det_can.fillStyle = (ruleNum & 2) ? 'black' : 'white';
    det_can.fillRect(x_offset + x_col_2, y_offset + y_row_2, box_w, box_h);

    det_can.fillStyle = (ruleNum & 4) ? 'black' : 'white';
    det_can.fillRect(x_offset + x_col_3, y_offset + y_row_2, box_w, box_h);
